...
class UserEmoAudioDAO(BaseDAO):
    ...
    def insert(self, user_id: int, role_id: int, emo_type: str, spk_audio_prompt: str,
               spk_emo_vector: str, spk_emo_alpha: float, emo_audio_prompt: str,
               emo_vector: str, emo_alpha: float) -> int:
        """
        插入用户情绪音频记录
    ...
    def query_by_user_role(self, user_id: int, role_id: int, emo_type: Optional[str] = None) -> List[Dict[str, Any]]:
        """
