...
dashscope.api_key = os.getenv("sk-d9c9aaa532a44f629758294cd17ecde1")
...
# 为音色起一个有意义的前缀
VOICE_PREFIX = "lxvoice" # 仅允许数字和小写字母，小于十个字符
# 公网可访问音频URL
...
try:
    ...
    text_to_synthesize = "小朋友们大家好，这是一段黄金母本的音频，这段音频的主要目的呀，是为后续的所有音频克隆提供一段完美的音频输入"
    ...
    # 6. 保存音频文件
    output_file = "outputs/my_custom_voice_output.mp3"
